...
export default function Herosection() {
  return (
    <div className='min-h-screen w-full flex flex-col justify-center items-center'>
      ...
      <p className='mt-8 text-2xl leading-relaxed max-w-2xl text-center'>SaaS kit with clean UI, authentication, payments, and simple docs, focus on what matters.</p>
